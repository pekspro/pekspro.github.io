...
you could use. In my
[next post]({% post_url /0053 Get time zone for a user in Graph/2021-04-04-get-time-zone-for-a-user-in-graph %}) 
I show how you could get the timezone  from the user's settings instead.
